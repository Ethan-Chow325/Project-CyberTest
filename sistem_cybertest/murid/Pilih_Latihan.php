	...
	<div class="w3-container w3-margin-bottom w3-table">
		<td align="center" width="100%">
			<div class="w3-responsive">
				<table width="100%" align="center" border="1" id="besar"  class="w3-2021-cerulean w3-text-black" bordercolor='#000000'>
					<tr>
						<td class="w3-center w3-2020-navy-blazer"><i class="fa fa-tags" aria-hidden="true"><b> Numbering </b></i></td>
						<td class="w3-center w3-2020-navy-blazer"><i class="fa fa-book" aria-hidden="true"><b> Subject Topics </b></i></td>
						<td class="w3-center w3-2020-navy-blazer"><i class="fa fa-folder-open" aria-hidden="true"><b> Exercise/Quiz </b></i></td>
						<td class="w3-center w3-2020-navy-blazer"><i class="fa fa-calculator" aria-hidden="true"><b> Question Count </b></i></td>
						<td class="w3-center w3-2020-navy-blazer"><i class="fa fa-star" aria-hidden="true"><b> Overall Score </b></i></td>
						<td class="w3-center w3-2020-navy-blazer"><i class="fa fa-pie-chart" aria-hidden="true"><b> Percentage </b></i></td>
						<td class="w3-center w3-2020-navy-blazer"><i class="fa fa-bullhorn" aria-hidden="true"><b> Operative Measures </b></i></td>
					</tr>
					...
					while ($data=mysqli_fetch_array($laksana))
					{
						...
						echo "<tr>
								...
								if ($bil_jawapan<=0)
								{
									...
									echo "<td><b><a class='w3-center w3-button w3-btn w3-hover-black w3-border w3-border-black w3-round-large w3-bar' href='Arahan_Latihan.php?NoSet=".$data['NoSet']."'>BEGIN EXERCISE/QUIZ</a></b></td>";
								}
