...
<div class="w3-row">
	...
	<div class="w3-half w3-container w3-card-4 w3-margin-top w3-margin-bottom w3-margin-right w3-theme-gradient-3">
		...
		<a class='w3-center w3-button w3-btn w3-hover-black w3-border w3-border-black w3-round-large w3-xlarge' href='Jawab_Soalan.php?NoSet=<?PHP echo $_GET['NoSet']; ?>&Masa=<?PHP echo $data['Masa']; ?>&Jenis=<?PHP echo $data['Jenis']; ?>'><b>LET'S BEGIN</b></a>
	</div>

	<!-- Educational Video -->
	<div class="w3-rest w3-container w3-margin-top w3-margin-bottom w3-card-4 w3-center w3-theme-gradient-3">
		<h2 class="w3-center w3-text-teal" style="text-shadow:4px 4px 0 #555"><i class="fa fa-film" aria-hidden="true"></i><b> C.S. Introductions </b><i class="fa fa-film" aria-hidden="true"></i></h2>
