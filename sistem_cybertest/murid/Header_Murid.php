	...
	<body background="../images/BG.jpg">
		...
		<div id="header">
			<div class="w3-container w3-blue-gray">
				...
				<br>
				<div class="w3-center">
					<h1 class="w3-xxxlarge font-effect-shadow-multiple w3-text-black"><i class="fa fa-podcast" aria-hidden="true"><b> CyberTest Quiz Network: Scholar's Menu</b></i></h1>
			...
			<div class="w3-bar w3-black w3-center w3-allerta">
				<b>
					...
					<div class="w3-bar-item w3-xlarge w3-right">
						<i class="fa fa-user-secret" aria-hidden="true"> <?PHP echo "Scholar:"." ".$_SESSION['NamaMurid']; ?> </i>
					</div>
		 		</b>
		 	</div>
