...
<div class="w3-table w3-container">
	...
	<form name="Soalan_Kuiz" action="Jawab_Semak2.php?NoSet=<?PHP echo $_GET['NoSet']; ?>" method='POST'>
		<table border="1" width="100%" id="besar" class="w3-2021-green-ash w3-text-black" bordercolor='#000000'>
			<tr>
				<td class="w3-center w3-2020-ultramarine-green" style="width: 10%"><i class="fa fa-tags" aria-hidden="true"><b> Numbering </b></i></td>
