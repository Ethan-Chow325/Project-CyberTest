...
<div class="w3-container">
	...
	echo "
		<table border='1' width='100%' id='besar' class='w3-table w3-2021-cerulean w3-text-black'>
			<tr>
				<td class='w3-center w3-2020-navy-blazer' style='width: 20%'><i class='fa fa-tags' aria-hidden='true'><b> Numbering </b></i></td>
	...
	foreach ($_POST as $key => $value)
	{
		...
		echo "<tr class='w3-2021-cerulean w3-text-black'>
