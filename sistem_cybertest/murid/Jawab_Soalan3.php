...
if (empty($_GET))
{
	...
	window.location.href='Pilih_Latihan3.php';</script>");
}
?>
...
<div class="w3-table w3-container">
	...
	<form name="Soalan_Kuiz" action="Jawab_Semak3.php?NoSet=<?PHP echo $_GET['NoSet']; ?>" method='POST'>
		<table border="1" width="100%" id="besar" class="w3-2018-crocus-petal w3-text-black" bordercolor='#000000'>
			<tr>
				<td class="w3-center w3-2020-magenta-purple" style="width: 10%"><i class="fa fa-tags" aria-hidden="true"><b> Numbering </b></i></td>
				<td class="w3-center w3-2020-magenta-purple" style="width: 80%"><i class="fa fa-file-text-o" aria-hidden="true"><b> Questions </b></i></td>
			</tr>
