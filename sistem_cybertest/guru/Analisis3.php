		...
		if (mysqli_num_rows($laksana_pilih)>=1)
		{
			...
			echo "	<div class='w3-container w3-table'>
					...
					echo"	</div>
						...
						<table width='100%' border='1' id='besar' class='w3-2018-crocus-petal w3-text-black w3-centered w3-margin-bottom' bordercolor='#000000'>
							<tr>
								<td class='w3-2020-magenta-purple'><i class='fa fa-tags' aria-hidden='true'></i><b> Scholar's Name </b></td>
								<td class='w3-2020-magenta-purple'><i class='fa fa-id-card' aria-hidden='true'></i><b> Identification Card Number </b></td>
								<td class='w3-2020-magenta-purple'><i class='fa fa-star' aria-hidden='true'></i><b> Overall Score </b></td>
								<td class='w3-2020-magenta-purple'><i class='fa fa-pie-chart' aria-hidden='true'></i><b> Percentage </b></td>
							</tr>";
							}
