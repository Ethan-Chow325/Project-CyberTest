...
<div class="w3-container w3-table">
	...
	<div class="w3-panel w3-black">
		<h2 align="center" class="w3-text-deep-orange" style="text-shadow: 2px 2px #555"><i class="fa fa-list" aria-hidden="true"><b> Exercises & Pop Quiz (Colorblind Settings) </b></i></h2>
	</div>
			...
			echo "<tr>
					...
					<td class='w3-center' style='vertical-align: middle;'><b>
						<div class='w3-container w3-center'>
							...
							<a href = 'Soalan_Daftar_Inverted.php?NoSet=".$data['NoSet']."&Topik=".$data['Topik']."' class='w3-center w3-button w3-block w3-btn w3-hover-black w3-border w3-border-black w3-round-large w3-medium'>QUESTION SET-UP</a>
