...
if (!empty($_POST))
{
	...
	if (mysqli_query($Connection, $arahan_simpan))
	{
		...
		window.location.href = 'Senarai_Kelas2.php';</script>";
	}
...
<div class="w3-container w3-table">
	...
	<table width="100%" align="center" border="1" id="besar" class="w3-2021-green-ash w3-text-black w3-margin-bottom" bordercolor='#000000'>
		<tr>
			<td class="w3-center w3-2020-ultramarine-green" style="width: 20% vertical-align: middle;"><i class="fa fa-tags" aria-hidden="true"><b> Classroom </b></i></td>
			<td class="w3-center w3-2020-ultramarine-green" style="width: 20% vertical-align: middle;"><i class="fa fa-empire" aria-hidden="true"><b> Classroom Name </b></i></td>
			<td class="w3-center w3-2020-ultramarine-green" style="width: 20% vertical-align: middle;"><i class="fa fa-briefcase" aria-hidden="true"><b> Assigned Teacher </b></i></td>
			<td class="w3-center w3-2020-ultramarine-green" style="width: 15% vertical-align: middle;"><i class="fa fa-id-card-o" aria-hidden="true"><b> Newly Assigned Teacher </b></i></td>
