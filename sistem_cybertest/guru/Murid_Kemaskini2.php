...
if (!empty($_POST))
{
	...
	if (mysqli_query($Connection, $arahan_kemaskini))
	{
		...
		window.location.href='Murid_Senarai2.php';</script>";
	}
...
<div class="w3-container w3-table">
	...
	<table width="100%" border="1" id="besar" class="w3-2021-green-ash w3-text-black w3-margin-bottom" bordercolor='#000000'>>
		<tr>
			<td class="w3-center w3-2020-ultramarine-green" style="width: 20% vertical-align: middle;"><i class="fa fa-tags" aria-hidden="true"><b> Scholar's Name </b></i></td>
			...
			<td class="w3-center w3-2020-ultramarine-green" style="width: 15% vertical-align: middle;"><i class="fa fa-empire" aria-hidden="true"><b> Assigned Classroom </b></i></td>
		...
		while ($data=mysqli_fetch_array($laksana_cari_murid))
		{
			...
			echo "<tr>
					...
					<td class='w3-center' style='vertical-align: middle;'><b>
						<div class='w3-center'>
							<a href='Murid_Kemaskini2.php?".http_build_query($data_Murid)."' class='w3-center w3-button w3-block w3-btn w3-hover-black w3-border w3-border-black w3-round-large w3-margin-right w3-medium'><b> UPDATE CREDENTIALS </b></a>
