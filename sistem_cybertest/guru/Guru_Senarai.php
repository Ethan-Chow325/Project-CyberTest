...
<div class="w3-container w3-table">
	...
	<table width="100%" align="center" border="1" id="besar" class="w3-2021-cerulean w3-text-black w3-margin-bottom" bordercolor='#000000'>
		<tr>
			<td class="w3-center w3-2020-navy-blazer" style="width: 20% vertical-align: middle;"><i class="fa fa-tags" aria-hidden="true"><b> User's Name </b></i></td>
			...
			<td class="w3-center w3-2020-navy-blazer" style="width: 15% vertical-align: middle;"><i class="fa fa-id-badge" aria-hidden="true"><b> Employment Status </b></i></td>
	...
	while ($data=mysqli_fetch_array($laksana_cari_guru))
	{
		...
		echo "<tr>
				...
				<td class='w3-center' style='vertical-align: middle;'><b>
					<div class='w3-center'>
						<a href='Guru_Kemaskini.php?".http_build_query($data_guru)."' class='w3-center w3-button w3-block w3-btn w3-hover-black w3-border w3-border-black w3-round-large w3-margin-right w3-medium'><b> UPDATE CREDENTIALS </b></a>
