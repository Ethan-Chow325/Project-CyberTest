...
if (!empty($_POST))
{
	...
	if (mysqli_query($Connection, $arahan_kemaskini))
	{
		...
		window.location.href='Soalan_Daftar_Inverted.php?NoSet=".$_GET['NoSet']."&Topik=".$_GET['Topik']."';</script>";
	}
...
<div class="w3-container w3-table">
	...
	<div class="w3-panel w3-black">
		<h2 align="center" class="w3-text-deep-orange" style="text-shadow: 2px 2px #555"><i class="fa fa-list" aria-hidden="true"><b> Exercise & Pop Quiz (Colorblind Settings): Questions Update Menu </b></i></h2>
	</div>
	...
	<table width="100%" border="1" id="besar" class="w3-2021-cerulean w3-text-black w3-centered w3-margin-bottom" bordercolor='#000000'>
		<tr>
			...
			<td class="w3-center w3-2020-navy-blazer" style="width: 15%"><i class="fa fa-toggle-on w3-text-red" aria-hidden="true"></i><b> Answer A </b></td>
			<td class="w3-center w3-2020-navy-blazer" style="width: 15%"><i class="fa fa-toggle-off w3-text-green" aria-hidden="true"></i><b> Answer B </b></td>
			<td class="w3-center w3-2020-navy-blazer" style="width: 15%"><i class="fa fa-toggle-off w3-text-green" aria-hidden="true"></i><b> Answer C </b></td>
			<td class="w3-center w3-2020-navy-blazer" style="width: 15%"><i class="fa fa-toggle-off w3-text-green" aria-hidden="true"></i><b> Answer D </b></td>
		...
		<tr>
			<form action="" method="POST">
				...
				<td bgcolor="red"><b><textarea class="w3-input" name="Jawapan_A" rows="4" cols="25">
					<?PHP echo $_GET['Jawapan_A']; ?>
				</textarea></b></td>

				<td bgcolor="green"><b><textarea class="w3-input" name="Jawapan_B" rows="4" cols="25">
					<?PHP echo $_GET['Jawapan_B']; ?>
				</textarea></b></td>

				<td bgcolor="green"><b><textarea class="w3-input" name="Jawapan_C" rows="4" cols="25">
					<?PHP echo $_GET['Jawapan_C']; ?>
				</textarea></b></td>

				<td bgcolor="green"><b><textarea class="w3-input" name="Jawapan_D" rows="4" cols="25">
